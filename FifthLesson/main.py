...
for i in range(11):
    for key, value in complex_alphabet.items():
        three_skills[0] = three_skills[0].replace(key, value)
        three_skills[1] = three_skills[1].replace(key, value)
        three_skills[2] = three_skills[2].replace(key, value)
